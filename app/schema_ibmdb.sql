...
CREATE TABLE R_CONTINENTES (
  ID_CONTINENTE INTEGER NOT NULL PRIMARY KEY,
...
CREATE TABLE R_PAISES_APELIDOS_TIPOS (
    ID_TIPO_APELIDO INTEGER NOT NULL PRIMARY KEY,
    TIPO_APELIDO VARCHAR(255) NOT NULL
);

CREATE TABLE R_PAISES_APELIDOS (
  ID_APELIDO_PAIS INTEGER NOT NULL PRIMARY KEY,
...
CREATE TABLE R_GRUPOS_GEOPOLITICOS (
  ID_GRUPO_GEOPOLITICO INTEGER NOT NULL PRIMARY KEY,
...
CREATE TABLE R_UNIVERSIDADES (
  ID_UNIVERSIDADE INTEGER NOT NULL PRIMARY KEY,
...
CREATE TABLE R_UNIVERSIDADES_APELIDOS (
  ID_APELIDO_UNIVERSIDADE INTEGER NOT NULL PRIMARY KEY,
...
CREATE TABLE R_UNIVERSIDADES_GRUPOS (
  ID_GRUPO_UNIVERSIDADES INTEGER NOT NULL PRIMARY KEY,
  NOME_GRUPO_PORTUGUES VARCHAR(255) NOT NULL,
  NOME_GRUPO_INGLES VARCHAR(255) NOT NULL
);
...
CREATE TABLE R_RANKINGS (
  ID_RANKING INTEGER NOT NULL PRIMARY KEY,
...
CREATE TABLE R_METRICAS (
  ID_METRICA INTEGER NOT NULL PRIMARY KEY,
...
CREATE TABLE R_PILARES_GRUPOS (
  ID_GRUPO_PILARES INTEGER NOT NULL PRIMARY KEY,
  NOME_GRUPO_PORTUGUES VARCHAR(255) NOT NULL,
  NOME_GRUPO_INGLES VARCHAR(255) NOT NULL
);
...
CREATE TABLE R_TIPOS_METADADOS (
  ID_TIPO_METADADO INTEGER NOT NULL PRIMARY KEY,
  NOME_TIPO_METADADO VARCHAR(255) NOT NULL
);

CREATE TABLE R_TIPOS_ENTIDADES (
  ID_TIPO_ENTIDADE INTEGER NOT NULL PRIMARY KEY,
