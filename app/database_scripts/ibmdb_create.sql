...
-- daqui pra baixo são dados de teste

-- select *
-- from R_PAISES_APELIDOS_TIPOS;
--
-- insert into R_CONTINENTES(NOME_CONTINENTE_PORTUGUES, NOME_CONTINENTE_INGLES) VALUES ('Continente Teste', 'Test Continent');
--
-- INSERT INTO R_PAISES(ID_CONTINENTE, NOME_PAIS_PORTUGUES, NOME_PAIS_INGLES) VALUES ((SELECT ID_CONTINENTE FROM R_CONTINENTES WHERE NOME_CONTINENTE_INGLES = 'Test Continent'), 'País Teste', 'Test Country');
--
-- insert INTO R_PAISES_APELIDOS(ID_TIPO_APELIDO, APELIDO, ID_PAIS) VALUES (
--     (SELECT ID_TIPO_APELIDO FROM R_PAISES_APELIDOS_TIPOS WHERE TIPO_APELIDO = 'Nome alternativo'),
--     'Test Country',
--     (SELECT ID_PAIS FROM R_PAISES WHERE NOME_PAIS_INGLES = 'Test Country')
-- );
--
--
-- INSERT INTO R_RANKINGS(NOME_RANKING) VALUES ('Test Ranking');
-- INSERT INTO R_PILARES(
--     ID_RANKING, NOME_PILAR_INGLES, NOME_PILAR_PORTUGUES, DESCRICAO_PILAR_PORTUGUES, DESCRICAO_PILAR_INGLES
-- ) VALUES
--     ((SELECT ID_RANKING FROM R_RANKINGS WHERE NOME_RANKING = 'Test Ranking'), 'Sample Pillar 1 (Score)', 'Pilar de Exemplo 1 (Score)', NULL, NULL),
--     ((SELECT ID_RANKING FROM R_RANKINGS WHERE NOME_RANKING = 'Test Ranking'), 'Sample Pillar 1 (Rank)', 'Pilar de Exemplo 1 (Rank)', NULL, NULL),
--     ((SELECT ID_RANKING FROM R_RANKINGS WHERE NOME_RANKING = 'Test Ranking'), 'Sample Pillar 2 (Score)', 'Pilar de Exemplo 2 (Score)', NULL, NULL),
--     ((SELECT ID_RANKING FROM R_RANKINGS WHERE NOME_RANKING = 'Test Ranking'), 'Sample Pillar 2 (Rank)', 'Pilar de Exemplo 2 (Rank)', NULL, NULL);
--
-- INSERT INTO R_UNIVERSIDADES(NOME_UNIVERSIDADE_PORTUGUES, NOME_UNIVERSIDADE_INGLES, SIGLA, ID_APELIDO_PAIS) VALUES
--     ('Universidade Teste', 'Test University', 'UTEST', (SELECT ID_APELIDO_PAIS FROM R_PAISES_APELIDOS WHERE APELIDO = 'Brasil'));
--
--
-- INSERT INTO R_UNIVERSIDADES_APELIDOS(ID_UNIVERSIDADE, APELIDO) VALUES (
--     (SELECT ID_UNIVERSIDADE FROM R_UNIVERSIDADES WHERE NOME_UNIVERSIDADE_INGLES = 'Test University'),
--     'Test University'
-- );
